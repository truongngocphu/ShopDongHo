...
namespace ShopDongHoMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(DongHoShopMvcContext context)
        {
            _context = context;
        }
        ...
        {
            var dongHoShopMvcContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await dongHoShopMvcContext.ToListAsync());
        }
