...
{
    [DbContext(typeof(DongHoShopMvcContext))]
    partial class DongHoShopMvcContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.BanBe", b =>
                {
                    b.Property<int>("MaBb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.ChiTietHd", b =>
                {
                    b.Property<int>("MaCt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.GopY", b =>
                {
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.HangHoa", b =>
                {
                    b.Property<int>("MaHh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.HoaDon", b =>
                {
                    b.Property<int>("MaHd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.HoiDap", b =>
                {
                    b.Property<int>("MaHd")
                        .HasColumnType("int")
                        .HasColumnName("MaHD");
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.NhaCungCap", b =>
                {
                    b.Property<string>("MaNcc")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.PhanCong", b =>
                {
                    b.Property<int>("MaPc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.PhongBan", b =>
                {
                    b.Property<string>("MaPb")
                        .HasMaxLength(7)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.VChiTietHoaDon", b =>
                {
                    b.Property<double>("DonGia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.YeuThich", b =>
                {
                    b.Property<int>("MaYt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.BanBe", b =>
                {
                    b.HasOne("ShopDongHoMVC.Data.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("ShopDongHoMVC.Data.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.ChiTietHd", b =>
                {
                    b.HasOne("ShopDongHoMVC.Data.HoaDon", "MaHdNavigation")
                        .WithMany("ChiTietHds")
                        .HasForeignKey("MaHd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.ChuDe", b =>
                {
                    b.HasOne("ShopDongHoMVC.Data.NhanVien", "MaNvNavigation")
                        .WithMany("ChuDes")
                        .HasForeignKey("MaNv")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.GopY", b =>
                {
                    b.HasOne("ShopDongHoMVC.Data.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.HangHoa", b =>
                {
                    b.HasOne("ShopDongHoMVC.Data.Loai", "MaLoaiNavigation")
                        .WithMany("HangHoas")
                    ...
                    b.HasOne("ShopDongHoMVC.Data.NhaCungCap", "MaNccNavigation")
                        .WithMany("HangHoas")
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.HoaDon", b =>
                {
                    ...
                    b.HasOne("ShopDongHoMVC.Data.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.PhanCong", b =>
                {
                    ...
                    b.HasOne("ShopDongHoMVC.Data.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("ShopDongHoMVC.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("ShopDongHoMVC.Data.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")
